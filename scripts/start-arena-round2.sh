...
# ============================================================
# Speech Arena - ラウンド2 (v1.1c, v1.1d)
# 使い方: ./scripts/stop-arena.sh && ./scripts/start-arena-round2.sh
# ============================================================

# --- 設定 ---------------------------------------------------
MODEL_A_NAME="llm-jp-moshi-v1.1-all-mixed"
MODEL_A_REPO="abePclWaseda/llm-jp-moshi-v1.1-all-mixed"
MODEL_A_GPU=0
MODEL_A_PORT=8998

MODEL_B_NAME="llm-jp-moshi-v1.1-all-staged"
MODEL_B_REPO="abePclWaseda/llm-jp-moshi-v1.1-all-staged"
MODEL_B_GPU=1
MODEL_B_PORT=8999
...
echo "=== DB にモデル情報を登録中 ==="
cd "$WEB_DIR"
MODEL_C_URL="$TUNNEL_A_URL" MODEL_D_URL="$TUNNEL_B_URL" npx tsx prisma/seed.ts
echo ""
