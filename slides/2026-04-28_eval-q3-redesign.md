...
| 評価観点 | Q1<br/>音声品質 | Q2<br/>タイミング | Q4<br/>応答内容 | 旧 Q3<br/>人らしさ |
|---|:---:|:---:|:---:|:---:|
| ノイズ・発音 | ● | | | ● |
| 応答の間 | | ● | | ● |
| 話題の妥当性 | | | ● | ● |
...
**旧 Q3 は Q1・Q2・Q4 の観点をすべて吸い込んでしまう** → 評価者は他 3 軸の影響も Q3 に載せてしまい、軸として独立しない。
...
# Q3 の先 — 個人／状況適応を学習で詰める

### Q3 のブレイクダウンは全て「相手・状況への適応」の問題
抑揚・感情表現・テンション・キャラ一貫性 → いずれも **相手／場面に合わせる** こと。
4/21 で出た「賑やか vs 淡々」「相手に応じた速度」「東芝システム: ロボット音声でも状況にマッチすれば人格として受容」はすべてこの軸に乗る。

<div class="diff">
  <div class="col before">
    <div class="label">評価側 — SLT 2026（本論文）</div>
    <div class="body">
      <ul>
        <li>FD-DMOS 5軸 + Layer 2 の確立</li>
        <li>Bradley-Terry による順位づけ</li>
        <li>100 名クラウドソーシング</li>
      </ul>
    </div>
  </div>
  <div class="col after">
    <div class="label">学習側 — IS 2027 / TASLP（次論文）</div>
    <div class="body">
      <ul>
        <li>Moshi fine-tune で相手／状況に適応</li>
        <li>prompt conditioning vs LoRA vs full FT</li>
        <li>提案評価フレームで差分を検証</li>
      </ul>
    </div>
  </div>
</div>

**評価 → 学習 → 再評価** の閉ループを一連の研究成果として提示する連作戦略。

---

# SLT Future Work + IS 2027 準備項目

### SLT 論文の Future Work に書く骨子
- Q3 評価で低スコアのモデルは「話し方が相手と噛み合っていない」傾向があると示唆（パイロットで確認）
- 個人／状況適応を**学習目的関数に組み込む**方向を次論文で扱うと明示
- 具体的には Moshi fine-tune における条件付け手法の比較を予告

### IS 2027 PoC のために先回り準備

| 項目 | 内容 | 時期 |
|---|---|---|
| サーベイ | Persona dialog, style adaptation, FD-Bench 後続研究の空き地確認 | 2026-05 |
| データ | ユーザー特性／状況ラベル付き対話コーパス（自作 or 既存流用） | 2026-06〜07 |
| 手法 | prompt conditioning / LoRA / full fine-tune の比較設計 | 2026-07〜09 |
| 評価 | SLT で確立した FD-DMOS を**そのまま再利用**して差分検証 | IS 2027 投稿時 |

→ 連作にすることで **評価フレーム自体の信頼性** も次論文で再確認できる
...
### 5. 連作戦略（Q3 → 学習側）
- SLT の Future Work として個人／状況適応を書く方針で OK か
- IS 2027 向けサーベイを 5 月から着手して良いか
