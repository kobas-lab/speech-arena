...
export const ServerAudio: FC<ServerAudioProps> = ({ setGetAudioStats, imageUrl, copyCanvasRef, onAnalyserChange }) => {
  ...
  useEffect(() => {
    if (onAnalyserChange) {
      onAnalyserChange(analyser.current);
    }
  }, [analyser, onAnalyserChange]);
